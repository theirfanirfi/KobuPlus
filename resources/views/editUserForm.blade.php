...
@section('maincontent')
 <div class="card" >
    ...
    @endif
                                ...
                                <div class="header">
                                        <h4>Edit User {{$info->e_firstname. " ".$info->e_lastname}}</h4>
...
<div class="row">
   <div class="col-md-6" style="margin:0 auto;float:none;margin-bottom:10px;">
    ...
    <br/>
    <div class="col-md-6">  <input type="Checkbox" {{$info->e_business_permission  == 1 ? "checked" : ""}}  name="b_plan" /> &nbsp;&nbsp; <strong>Business Plan</strong></div>
     <div class="col-md-6">  <input type="Checkbox" {{$info->e_contacts_permission  == 1 ? 'checked' : ''}} name="contacts" /> &nbsp;&nbsp; <strong>Contacts</strong></div>
    <div class="col-md-6">  <input type="Checkbox" {{$info->e_permission == 1 ? 'checked' : ''}} name="enterprises"/> &nbsp;&nbsp; <strong>Enterprise</strong></div>
     <div class="col-md-6">  <input type="Checkbox" {{$info->e_social_ads == 1 ? 'checked' : ''}} name="socialAds" /> &nbsp;&nbsp; <strong>Social Ads</strong></div>
    <div class="col-md-6">  <input type="Checkbox" {{$info->e_sharedocs == 1 ? 'checked' : ''}} name="shareDocuments"/> &nbsp;&nbsp; <strong>Share Documents</strong></div>
     <div class="col-md-6">  <input type="Checkbox" {{$info->e_settings == 1 ? 'checked' : ''}} name="enterprise_settings" /> &nbsp;&nbsp; <strong>Enterprise Settings</strong></div>
    <div class="col-md-6">  <input type="Checkbox" {{$info->e_user_permission == 1 ? 'checked' : ''}} name="users"/> &nbsp;&nbsp; <strong>Users</strong></div>
